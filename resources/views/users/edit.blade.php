...
<head>
    ...
    <title>Modifier un Employé - Szlazak Gestion</title>
    ...
    <main class="container py-5">
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-user-edit me-3"></i>Modifier un Employé</h1>
                    <p class="mb-0 mt-2" style="opacity: 0.9;">Mettez à jour les informations du membre</p>
                </div>
