                    ...
                    <div class="mb-4">
                        ...
                        <div class="type-selector">
                            <div class="type-option">
                                <input type="radio" id="type-chantier" name="type" value="chantier" {{ old('type') == 'chantier' ? 'checked' : 'checked' }}>
                            ...
                            <div class="type-option">
                                <input type="radio" id="type-reunion" name="type" value="reunion" {{ old('type') == 'reunion' ? 'checked' : '' }}>
                            ...
                            <div class="type-option">
                                <input type="radio" id="type-maintenance" name="type" value="maintenance" {{ old('type') == 'maintenance' ? 'checked' : '' }}>
                            ...
                            <div class="type-option">
                                <input type="radio" id="type-livraison" name="type" value="livraison" {{ old('type') == 'livraison' ? 'checked' : '' }}>
                            ...
                            <div class="type-option">
                                <input type="radio" id="type-inspection" name="type" value="inspection" {{ old('type') == 'inspection' ? 'checked' : '' }}>
                            ...
                            <div class="type-option">
                                <input type="radio" id="type-autre" name="type" value="autre" {{ old('type') == 'autre' ? 'checked' : '' }}>
