...
<head>
    ...
    <title>Nouveau Stockage - Szlazak Gestion</title>
    ...
    <main class="container py-5">
        <div class="page-header animate__animated animate__fadeIn">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-plus-circle me-3"></i>Nouveau Stockage</h1>
                    <p class="mb-0 mt-2" style="opacity: 0.9;">Ajoutez un nouvel élément au stock</p>
                </div>
