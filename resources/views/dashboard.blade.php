...
<body>
    ...
    <main class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 animate__animated animate__fadeIn">
            ...
            <div>
                <span class="me-3"><i class="fas fa-calendar-alt me-1"></i>{{ date('d/m/Y') }}</span>
                <span><i class="fas fa-clock me-1"></i><span id="current-time">{{ date('H:i') }}</span></span>
            </div>
        </div>
        ...
        <div class="quick-access-section row g-4 mb-5 animate__animated animate__fadeIn animate__delay-3s">
            ...
            <div class="col-lg-4 quick-access-container">
                <div class="quick-access h-100">
                    ...
                    <a href="{{ route('chantiers.create') }}" class="quick-access-btn">
                        <i class="fas fa-plus"></i>Nouveau Chantier
                    </a>
                    <a href="{{ route('equipements.create') }}" class="quick-access-btn">
                        <i class="fas fa-plus"></i>Nouvel Équipement
                    </a>
                    <a href="{{ route('users.create') }}" class="quick-access-btn">
                        <i class="fas fa-user-plus"></i>Nouvel Employé
                    </a>
                    <a href="{{ route('evenements.create') }}" class="quick-access-btn">
