    ...
    <main class="container py-5">
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 mt-2" style="opacity: 0.9;">Vos déclarations</p>
                </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card-lite">
                    <h6 class="mb-2">{{ $timesheet->chantier->nom ?? 'N/A' }}</h6>
                    <div class="mb-2">
                    ...
                    <div class="mt-3">
                        <a href="{{ route('timesheets.show', $timesheet->id) }}" class="btn btn-outline-primary btn-sm">
