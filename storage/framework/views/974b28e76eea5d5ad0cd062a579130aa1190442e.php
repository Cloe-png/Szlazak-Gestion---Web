...
<head>
    ...
    <title><?php echo e($user->nom ?? 'Utilisateur'); ?> - Profil - Szlazak Gestion</title>
...
<body>
    ...
    <main class="container py-5">
                ...
                <div>
                    ...
                    <div class="d-flex align-items-center mt-2" style="opacity: 0.9;">
                        <span class="role-badge role-<?php echo e(strtolower(str_replace(' ', '-', $user->role->nom))); ?>">
                            <i class="fas fa-<?php echo e($user->role->nom == 'Administrateur' ? 'user-shield' : 
                                ($user->role->nom == 'Chef de chantier' ? 'hard-hat' : 
                                ($user->role->nom == 'Ouvrier' ? 'tools' : 
                                ($user->role->nom == 'Apprenti' ? 'user-graduate' : 'clock')))); ?> me-2"></i>
                            <?php echo e($user->role->nom); ?>

                        </span>
                        <span class="ms-3"><i class="fas fa-hashtag me-1"></i>#EM<?php echo e(str_pad($user->id, 4, '0', STR_PAD_LEFT)); ?></span>
                    </div>
                </div>
        ...
        <div class="profile-card animate__animated animate__fadeIn animate__delay-1s">
            <div class="profile-header">
                ...
                <div class="profile-info">
                    <div class="profile-name"><?php echo e($user->nom); ?></div>
            ...
            <div class="profile-stats">
                <div class="stat-item">
                    ...
                    <div class="stat-value"><?php echo e($stats['chantiers_count'] ?? 0); ?></div>
                    <div class="stat-label">Chantiers</div>
                </div>
                <div class="stat-item">
                    <i class="fas fa-clock stat-icon"></i>
                    <div class="stat-value"><?php echo e($stats['total_heures'] ?? 0); ?>h</div>
                    <div class="stat-label">Heures totales</div>
                </div>
                <div class="stat-item">
                    <i class="fas fa-calendar-day stat-icon"></i>
                    <div class="stat-value"><?php echo e($stats['jours_travailles'] ?? 0); ?></div>
                    <div class="stat-label">Jours travaillés</div>
                </div>
                <div class="stat-item">
                    <i class="fas fa-plus-circle stat-icon text-warning"></i>
                    <div class="stat-value"><?php echo e($stats['heures_supp_total'] ?? 0); ?>h</div>
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        ...
                        <a href="tel:<?php echo e($user->telephone); ?>" class="btn btn-sm btn-outline-success ms-2">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        ...
                        <a href="https://maps.google.com/?q=<?php echo e(urlencode($user->adresse)); ?>" 
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        <?php echo e(\Carbon\Carbon::parse($user->date_embauche)->format('d/m/Y')); ?>

                        <span class="text-muted ms-2">
                            (<?php echo e(\Carbon\Carbon::parse($user->date_embauche)->diffForHumans()); ?>)
                        </span>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="action-buttons animate__animated animate__fadeIn animate__delay-2s">
                ...
                <a href="<?php echo e(route('users.index')); ?>" class="btn-primary-custom">
        ...
        <div class="timesheet-container animate__animated animate__fadeIn animate__delay-3s" style="margin-top: 30px;">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('timesheets.create', ['user_id' => $user->id])); ?>" class="btn btn-sm btn-primary">
                    <i class="fas fa-plus me-1"></i>Ajouter une fiche
                </a>
            </div>
            
            <?php if($timesheets && $timesheets->count() > 0): ?>
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($timesheet->date_formatee ?? 'N/A'); ?></td>
                            <td><?php echo e($timesheet->jour ?? 'N/A'); ?></td>
                            <td>
                                <?php if($timesheet->chantier): ?>
                            ...
                            <td><?php echo e($timesheet->heure_debut_formatee ?? 'N/A'); ?> - <?php echo e($timesheet->heure_fin_formatee ?? 'N/A'); ?></td>
                            <td>
                            ...
                            <td><?php echo e($timesheet->heures_supp ?? 0); ?>h</td>
                            <td><strong><?php echo e($timesheet->total_heures ?? 0); ?>h</strong></td>
                        </tr>
            ...
            <?php if($statsParMois && $statsParMois->count() > 0): ?>
            <div class="mt-4">
                <h6 class="mb-3" style="color: var(--bleu-marine);">
                    <i class="fas fa-chart-bar me-2"></i>Statistiques par mois
                </h6>
                <div class="row">
                    <?php $__currentLoopData = $statsParMois; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 col-sm-6 mb-3">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="card-subtitle mb-2 text-muted"><?php echo e($stat->mois ?? 'N/A'); ?></h6>
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <small class="text-muted">Jours</small>
                                        <div class="fw-bold"><?php echo e($stat->jours ?? 0); ?></div>
                                    </div>
                                    <div>
                                        <small class="text-muted">Heures</small>
                                        <div class="fw-bold"><?php echo e($stat->heures ?? 0); ?>h</div>
                                    </div>
                                    <div>
                                        <small class="text-muted">Suppl.</small>
                                        <div class="fw-bold text-warning"><?php echo e($stat->heures_supp ?? 0); ?>h</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="timeline-container animate__animated animate__fadeIn animate__delay-3s">
            ...
            <div class="timeline">
                ...
                <?php if(($stats['chantiers_count'] ?? 0) > 0): ?>
                <div class="timeline-item">
                    <div class="timeline-date">
                        <?php echo e(now()->subDays(rand(1, 30))->format('d/m/Y')); ?>

                    </div>
                    <div class="timeline-content">
                        <strong>Assignation à un chantier</strong>
                        <p class="mb-0">Responsable de <?php echo e($stats['chantiers_count']); ?> chantier<?php echo e($stats['chantiers_count'] > 1 ? 's' : ''); ?></p>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="timeline-item">
                    <div class="timeline-date">
                        <?php echo e(now()->subHours(rand(1, 24))->format('d/m/Y H:i')); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const role = "<?php echo e(strtolower(str_replace(' ', '-', $user->role->nom))); ?>";
...
</html><?php /**PATH C:\wamp64\www\constructo\resources\views/users/show.blade.php ENDPATH**/ ?>