...
<body>
    <div class="container container-custom animate__animated animate__fadeIn">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo e(route('chantiers.index')); ?>" class="btn-custom">
        ...
        <form action="<?php echo e(route('chantiers.update', $chantier->id)); ?>" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 form-group-custom">
                    ...
                    <input type="text" class="form-control" id="nom" name="nom" value="<?php echo e($chantier->nom); ?>" required>
                </div>

                <div class="col-md-6 form-group-custom">
                    <label for="statut">Statut</label>
                    <select class="form-select" id="statut" name="statut" required>
                        <option value="En cours" <?php echo e($chantier->statut == 'En cours' ? 'selected' : ''); ?>>En cours</option>
                        <option value="À venir" <?php echo e($chantier->statut == 'À venir' ? 'selected' : ''); ?>>À venir</option>
                        <option value="Terminé" <?php echo e($chantier->statut == 'Terminé' ? 'selected' : ''); ?>>Terminé</option>
                    </select>
                </div>

                <div class="col-md-6 form-group-custom">
                    <label for="date_debut">Date de Début</label>
                    <input type="date" class="form-control" id="date_debut" name="date_debut" value="<?php echo e($chantier->date_debut ? $chantier->date_debut->format('Y-m-d') : ''); ?>">
                </div>

                <div class="col-md-6 form-group-custom">
                    <label for="date_fin">Date de Fin</label>
                    <input type="date" class="form-control" id="date_fin" name="date_fin" value="<?php echo e($chantier->date_fin ? $chantier->date_fin->format('Y-m-d') : ''); ?>">
                </div>

                <div class="col-12 form-group-custom">
                    <label for="adresse">Adresse</label>
                    <textarea class="form-control" id="adresse" name="adresse" rows="3" required><?php echo e($chantier->adresse); ?></textarea>
                </div>
                ...
                <div class="col-md-6 form-group-custom">
                    ...
                    <select class="form-select" id="responsable_id" name="responsable_id" required>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($user->id); ?>" <?php echo e($chantier->responsable_id == $user->id ? 'selected' : ''); ?>><?php echo e($user->nom); ?></option>
...
<?php /**PATH C:\wamp64\www\constructo\resources\views/chantiers/edit.blade.php ENDPATH**/ ?>