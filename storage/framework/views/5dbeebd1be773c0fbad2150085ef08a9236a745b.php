    ...
    <main class="container py-5">
        ...
        <div class="page-header animate__animated animate__fadeIn">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 mt-2" style="opacity: 0.9;">Modifiez les informations de l'événement #EV<?php echo e(str_pad($evenement->id, 4, '0', STR_PAD_LEFT)); ?></p>
                </div>
                <div>
                    <a href="<?php echo e(route('evenements.show', $evenement->id)); ?>" class="btn btn-light btn-lg me-2">
        ...
        <div class="event-preview animate__animated animate__fadeIn animate__delay-1s">
            <div class="preview-header">
                ...
                <span class="preview-badge preview-<?php echo e($evenement->type ?? 'autre'); ?>">
                    <i class="fas fa-<?php echo e($evenement->type == 'chantier' ? 'project-diagram' : ($evenement->type == 'reunion' ? 'users' : ($evenement->type == 'maintenance' ? 'tools' : ($evenement->type == 'livraison' ? 'truck' : ($evenement->type == 'inspection' ? 'search' : 'calendar'))) )); ?> me-1"></i>
                    <?php echo e(ucfirst($evenement->type ?? 'Événement')); ?>
            ...
            <div class="preview-details">
                <div class="preview-item">
                    ...
                    <strong>Titre :</strong> <span id="previewTitre"><?php echo e($evenement->titre); ?></span>
                </div>
                <div class="preview-item">
                    <i class="fas fa-clock" style="color: var(--bleu-marine); width: 20px;"></i>
                    <strong>Date :</strong> 
                    <span id="previewDateDebut"><?php echo e(\Carbon\Carbon::parse($evenement->date_debut)->format('d/m/Y H:i')); ?></span>
                    <?php if($evenement->date_fin): ?>
                        <span> → </span>
                        <span id="previewDateFin"><?php echo e(\Carbon\Carbon::parse($evenement->date_fin)->format('d/m/Y H:i')); ?></span>
                    <?php endif; ?>
                </div>
                <div class="preview-item">
                    <i class="fas fa-user-tie" style="color: var(--bleu-marine); width: 20px;"></i>
                    <strong>Responsable :</strong> <span id="previewResponsable"><?php echo e($evenement->user->nom ?? 'Non assigné'); ?></span>
                </div>
                <?php if($evenement->chantier): ?>
                <div class="preview-item">
                    <i class="fas fa-project-diagram" style="color: var(--bleu-marine); width: 20px;"></i>
                    <strong>Chantier :</strong> <span id="previewChantier"><?php echo e($evenement->chantier->nom); ?></span>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="form-container animate__animated animate__fadeIn animate__delay-2s">
            <form action="<?php echo e(route('evenements.update', $evenement->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-section">
                        ...
                        <div class="type-selector">
                            <div class="type-option">
                                <input type="radio" id="type-chantier" name="type" value="chantier" 
                                       <?php echo e(old('type', $evenement->type) == 'chantier' ? 'checked' : ''); ?>>
                            ...
                            <div class="type-option">
                                <input type="radio" id="type-reunion" name="type" value="reunion" 
                                       <?php echo e(old('type', $evenement->type) == 'reunion' ? 'checked' : ''); ?>>
                            ...
                            <div class="type-option">
                                <input type="radio" id="type-maintenance" name="type" value="maintenance" 
                                       <?php echo e(old('type', $evenement->type) == 'maintenance' ? 'checked' : ''); ?>>
                            ...
                            <div class="type-option">
                                <input type="radio" id="type-livraison" name="type" value="livraison" 
                                       <?php echo e(old('type', $evenement->type) == 'livraison' ? 'checked' : ''); ?>>
                            ...
                            <div class="type-option">
                                <input type="radio" id="type-inspection" name="type" value="inspection" 
                                       <?php echo e(old('type', $evenement->type) == 'inspection' ? 'checked' : ''); ?>>
                            ...
                            <div class="type-option">
                                <input type="radio" id="type-autre" name="type" value="autre" 
                                       <?php echo e(old('type', $evenement->type) == 'autre' ? 'checked' : ''); ?>>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="4" 
                                  placeholder="Décrivez l'événement, les objectifs, les points importants..."><?php echo e(old('description', $evenement->description)); ?></textarea>
                    ...
                    <div class="datetime-group">
                        <div class="mb-3" style="flex: 1;">
                            ...
                            <input type="datetime-local" class="form-control" id="date_debut" 
                                   name="date_debut" 
                                   value="<?php echo e(old('date_debut', \Carbon\Carbon::parse($evenement->date_debut)->format('Y-m-d\TH:i'))); ?>" 
                                   required
                        ...
                        <div class="mb-3" style="flex: 1;">
                            ...
                            <input type="datetime-local" class="form-control" id="date_fin" 
                                   name="date_fin" 
                                   value="<?php echo e(old('date_fin', $evenement->date_fin ? \Carbon\Carbon::parse($evenement->date_fin)->format('Y-m-d\TH:i') : '')); ?>"
                                   onchange="updateDatePreview()">
                            ...
                            <select class="form-select" id="user_id" name="user_id" required
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($user->id); ?>" 
                                        <?php echo e(old('user_id', $evenement->user_id) == $user->id ? 'selected' : ''); ?>>
                                        <?php echo e($user->nom); ?>
                            ...
                            <select class="form-select" id="chantier_id" name="chantier_id"
                                ...
                                <?php $__currentLoopData = $chantiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chantier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($chantier->id); ?>" 
                                        <?php echo e(old('chantier_id', $evenement->chantier_id) == $chantier->id ? 'selected' : ''); ?>>
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="statut" name="statut" required>
                            <option value="À venir" <?php echo e(old('statut', $evenement->statut) == 'À venir' ? 'selected' : ''); ?>>À venir</option>
                            <option value="En cours" <?php echo e(old('statut', $evenement->statut) == 'En cours' ? 'selected' : ''); ?>>En cours</option>
                ...
                <div class="action-buttons">
                    <a href="<?php echo e(route('evenements.show', $evenement->id)); ?>" class="btn btn-secondary btn-lg">
...
</html><?php /**PATH C:\wamp64\www\constructo\resources\views/evenements/edit.blade.php ENDPATH**/ ?>