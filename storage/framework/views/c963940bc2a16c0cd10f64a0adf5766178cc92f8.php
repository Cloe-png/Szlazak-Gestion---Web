...
<body>
    ...
    <div class="container py-5 animate__animated animate__fadeIn">
        <div class="form-container">
            ...
            <form action="<?php echo e(route('equipements.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="quantite" name="quantite" 
                               value="<?php echo e(old('quantite', 1)); ?>" min="1" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="date_achat" name="date_achat" 
                               value="<?php echo e(old('date_achat')); ?>">
                    </div>
                    
                    <div class="col-md-6 mb-3">
                        <label for="etat" class="form-label">État</label>
                        <select class="form-select" id="etat" name="etat" required>
                            <option value="" <?php echo e(old('etat') == '' ? 'selected' : ''); ?>>Sélectionnez un état</option>
                            <option value="Neuf" <?php echo e(old('etat') == 'Neuf' ? 'selected' : ''); ?>>Neuf</option>
                            <option value="Bon état" <?php echo e(old('etat') == 'Bon état' ? 'selected' : ''); ?>>Bon état</option>
                            <option value="Usé" <?php echo e(old('etat') == 'Usé' ? 'selected' : ''); ?>>Usé</option>
                            <option value="En maintenance" <?php echo e(old('etat') == 'En maintenance' ? 'selected' : ''); ?>>En maintenance</option>
                        </select>
                    </div>
                </div>
...
</html><?php /**PATH C:\wamp64\www\constructo\resources\views/equipements/create.blade.php ENDPATH**/ ?>