...
<body>
    ...
    <main class="container py-5">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 mt-2" style="opacity: 0.9;">
                        <?php echo e(\Carbon\Carbon::parse($timesheet->date_travail)->format('d/m/Y')); ?> - 
                        <?php echo e($timesheet->user->nom); ?>

                    </p>
                </div>
                <a href="<?php echo e(route('users.show', $timesheet->user_id)); ?>" class="btn btn-light btn-lg">
        ...
        <!-- Form Card -->
        <div class="form-card">
            <form action="<?php echo e(route('timesheets.update', $timesheet)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <select name="user_id" class="form-select" required>
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>" 
                                    <?php echo e(old('user_id', $timesheet->user_id) == $user->id ? 'selected' : ''); ?>>
                                    <?php echo e($user->nom); ?> - <?php echo e($user->role->nom); ?>
                        ...
                        <select name="chantier_id" class="form-select" required>
                            <?php $__currentLoopData = $chantiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chantier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($chantier->id); ?>" 
                                    <?php echo e(old('chantier_id', $timesheet->chantier_id) == $chantier->id ? 'selected' : ''); ?>>
                                    <?php echo e($chantier->nom); ?> (<?php echo e($chantier->statut); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" name="date_travail" class="form-control" 
                               value="<?php echo e(old('date_travail', $timesheet->date_travail->format('Y-m-d'))); ?>" required>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="time" name="heure_debut" class="form-control" 
                               value="<?php echo e(old('heure_debut', \Carbon\Carbon::parse($timesheet->heure_debut)->format('H:i'))); ?>" required>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="time" name="heure_fin" class="form-control" 
                               value="<?php echo e(old('heure_fin', \Carbon\Carbon::parse($timesheet->heure_fin)->format('H:i'))); ?>" required>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="heures_supp" class="form-control" 
                               step="0.5" min="0" value="<?php echo e(old('heures_supp', $timesheet->heures_supp)); ?>"
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="zone" class="form-select">
                            ...
                            <option value="1" <?php echo e(old('zone', $timesheet->zone) == '1' ? 'selected' : ''); ?>>Zone 1</option>
                            <option value="2" <?php echo e(old('zone', $timesheet->zone) == '2' ? 'selected' : ''); ?>>Zone 2</option>
                            <option value="3" <?php echo e(old('zone', $timesheet->zone) == '3' ? 'selected' : ''); ?>>Zone 3</option>
                            <option value="4" <?php echo e(old('zone', $timesheet->zone) == '4' ? 'selected' : ''); ?>>Zone 4</option>
                        </select>
                ...
                <div class="d-flex justify-content-between mt-4 pt-4 border-top">
                    ...
                    <div>
                        <a href="<?php echo e(route('users.show', $timesheet->user_id)); ?>" class="btn btn-outline-danger me-2">
...
</html><?php /**PATH C:\wamp64\www\constructo\resources\views/timesheets/edit.blade.php ENDPATH**/ ?>