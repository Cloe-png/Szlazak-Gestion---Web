    ...
    <div class="container py-5 animate__animated animate__fadeIn">
        <div class="form-container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('equipements.index')); ?>" class="btn btn-outline-secondary">
                    <i class="fas fa-arrow-left me-1"></i>Retour
                </a>
            </div>

            <div class="equipment-info">
                <strong>Référence :</strong> #EQ<?php echo e(str_pad($equipement->id, 3, '0', STR_PAD_LEFT)); ?><br>
                <strong>Dernière modification :</strong> <?php echo e($equipement->updated_at ? $equipement->updated_at->format('d/m/Y à H:i') : '--'); ?>
            ...
            <form action="<?php echo e(route('equipements.update', $equipement->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom" 
                               value="<?php echo e(old('nom', $equipement->nom)); ?>" required>
                    </div>
                    
                    <div class="col-md-6 mb-3">
                        <label for="quantite" class="form-label">Quantité</label>
                        <input type="number" class="form-control" id="quantite" name="quantite" 
                               value="<?php echo e(old('quantite', $equipement->quantite)); ?>" min="1" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="date_achat" name="date_achat" 
                               value="<?php echo e(old('date_achat', $equipement->date_achat)); ?>">
                    </div>
                    
                    <div class="col-md-6 mb-3">
                        <label for="etat" class="form-label">État</label>
                        <select class="form-select" id="etat" name="etat" required>
                            <option value="Neuf" <?php echo e(old('etat', $equipement->etat) == 'Neuf' ? 'selected' : ''); ?>>Neuf</option>
                            <option value="Bon état" <?php echo e(old('etat', $equipement->etat) == 'Bon état' ? 'selected' : ''); ?>>Bon état</option>
                            <option value="Usé" <?php echo e(old('etat', $equipement->etat) == 'Usé' ? 'selected' : ''); ?>>Usé</option>
                            <option value="En maintenance" <?php echo e(old('etat', $equipement->etat) == 'En maintenance' ? 'selected' : ''); ?>>En maintenance</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="localisation" name="localisation" 
                           value="<?php echo e(old('localisation', $equipement->localisation)); ?>">
                </div>
                
                <div class="d-flex justify-content-end gap-3 mt-4">
                    <a href="<?php echo e(route('equipements.index')); ?>" class="btn btn-secondary">
...
</html><?php /**PATH C:\wamp64\www\constructo\resources\views/equipements/edit.blade.php ENDPATH**/ ?>