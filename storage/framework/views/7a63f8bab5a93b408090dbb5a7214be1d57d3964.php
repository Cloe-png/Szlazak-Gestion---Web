...
<body>
    ...
    <main class="container py-5">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <div class="d-flex align-items-center mb-2">
                        <a href="<?php echo e(route('chantiers.index')); ?>" class="text-white me-3">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        <h1 class="mb-0">Détails du Chantier</h1>
                    </div>
                    <p class="mb-0" style="opacity: 0.9;">#CH<?php echo e(str_pad($chantier->id, 4, '0', STR_PAD_LEFT)); ?></p>
                </div>
                <div>
                    <span class="badge-custom 
                        <?php if($chantier->statut == 'En cours'): ?> badge-en-cours
                        <?php elseif($chantier->statut == 'Terminé'): ?> badge-termine
                        <?php elseif($chantier->statut == 'À venir'): ?> badge-a-venir
                        <?php else: ?> badge-annule <?php endif; ?>">
        ...
        <div class="action-buttons animate__animated animate__fadeIn animate__delay-1s">
            <a href="<?php echo e(route('chantiers.edit', $chantier->id)); ?>" class="btn-action btn-edit">
                <i class="fas fa-edit"></i> Modifier
            </a>
            <form action="<?php echo e(route('chantiers.destroy', $chantier->id)); ?>" method="POST" class="d-inline" id="deleteForm">
                <?php echo csrf_field(); ?>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-lg-8">
                <div class="container-custom animate__animated animate__fadeIn animate__delay-2s">
                    <div class="row mb-4">
                        <div class="col-12">
                            <h3><?php echo e($chantier->nom); ?></h3>
                            <p class="text-muted mb-0"><?php echo e($chantier->description ?? 'Aucune description'); ?></p>
                        </div>
                    </div>
                                ...
                                <ul class="info-list">
                                    <li class="info-item">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <div class="info-value">
                                                <?php echo e($chantier->date_debut ? \Carbon\Carbon::parse($chantier->date_debut)->format('d/m/Y') : 'Non définie'); ?>
                                    ...
                                    <li class="info-item">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <div class="info-value">
                                                <?php echo e($chantier->date_fin ? \Carbon\Carbon::parse($chantier->date_fin)->format('d/m/Y') : 'Non définie'); ?>
                                    ...
                                    <li class="info-item">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <div class="info-value">
                                                <?php if($chantier->date_debut && $chantier->date_fin): ?>
                                                    <?php echo e(\Carbon\Carbon::parse($chantier->date_debut)->diffInDays($chantier->date_fin)); ?> jours
                                                <?php else: ?>
                                                    Non définie
                                                <?php endif; ?>
                                            </div>
                                ...
                                <ul class="info-list">
                                    <li class="info-item">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <div class="info-value">
                                                <?php echo e($chantier->responsable->nom ?? 'Non assigné'); ?>
                            ...
                            <div class="col-md-4">
                                <div class="text-center p-3">
                                    <div class="h5 mb-1" style="color: var(--bleu-marine);">
                                        <?php echo e(number_format($chantier->budget ?? 0, 0, ',', ' ')); ?> €
                                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="container-custom animate__animated animate__fadeIn animate__delay-2s">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-muted"><?php echo e($chantier->adresse ?? 'Adresse non renseignée'); ?></p>
                        <?php if($chantier->code_postal || $chantier->ville): ?>
                        <p class="text-muted mb-0">
                            <?php echo e($chantier->code_postal ?? ''); ?> <?php echo e($chantier->ville ?? ''); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                ...
                fetch(url)
                    ...
                    .then(data => {
                        if (data && data.length > 0) {
                            ...
                            marker.bindPopup(`
                                <strong><?php echo e($chantier->nom); ?></strong><br>
            ...
            const address = "<?php echo e($chantier->adresse ?? ''); ?>";
            if (address) {
            ...
            function getWeatherForAddress() {
                ...
                const city = "<?php echo e($chantier->ville ?? 'Paris'); ?>";
...
</html><?php /**PATH C:\wamp64\www\constructo\resources\views/chantiers/show.blade.php ENDPATH**/ ?>