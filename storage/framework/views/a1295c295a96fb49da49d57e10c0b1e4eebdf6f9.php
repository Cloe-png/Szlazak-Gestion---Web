...
<body>
    <div class="container container-custom animate__animated animate__fadeIn">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="mb-0">Créer un Chantier</h1>
            <a href="<?php echo e(route('chantiers.index')); ?>" class="btn-custom">
                <i class="fas fa-arrow-left"></i>Retour
            </a>
        </div>

        <form action="<?php echo e(route('chantiers.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="row">
...
<?php /**PATH C:\wamp64\www\constructo\resources\views/chantiers/create.blade.php ENDPATH**/ ?>